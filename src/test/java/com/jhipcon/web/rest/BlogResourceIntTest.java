...
public class BlogResourceIntTest {
    ...
    private static final byte[] DEFAULT_POST = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_POST = TestUtil.createByteArray(2, "1");
    private static final String DEFAULT_POST_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_POST_CONTENT_TYPE = "image/png";
    ...
    public static Blog createEntity() {
        Blog blog = new Blog()
            ...
            .post(DEFAULT_POST)
            .postContentType(DEFAULT_POST_CONTENT_TYPE);
        return blog;
    }
    ...
    public void createBlog() throws Exception {
        ...
        assertThat(testBlog.getPostContentType()).isEqualTo(DEFAULT_POST_CONTENT_TYPE);
    }
    ...
    public void getAllBlogs() throws Exception {
        ...
        restBlogMockMvc.perform(get("/api/blogs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].postContentType").value(hasItem(DEFAULT_POST_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].post").value(hasItem(Base64Utils.encodeToString(DEFAULT_POST))));
    }
    ...
    public void getBlog() throws Exception {
        ...
        restBlogMockMvc.perform(get("/api/blogs/{id}", blog.getId()))
            ...
            .andExpect(jsonPath("$.postContentType").value(DEFAULT_POST_CONTENT_TYPE))
            .andExpect(jsonPath("$.post").value(Base64Utils.encodeToString(DEFAULT_POST)));
    }
    @Test
    ...
    public void updateBlog() throws Exception {
        ...
        updatedBlog
            ...
            .post(UPDATED_POST)
            .postContentType(UPDATED_POST_CONTENT_TYPE);
        ...
        assertThat(testBlog.getPostContentType()).isEqualTo(UPDATED_POST_CONTENT_TYPE);
    }
